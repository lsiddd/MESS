...
Mobility predixtion schemes applied to the 2009 measurement campain Cabspotting.

The implemented techniques so far use:

* Extended Kalman Filter

* ARIMA - autoregressive integrated moving average

**I DO NOT OWN THE MEASUREMENTS DATA**, if you find it useful, please cite the original work shown below.
